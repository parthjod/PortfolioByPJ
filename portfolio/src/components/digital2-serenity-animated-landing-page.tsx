...
const DigitalSerenity2 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/30 via-indigo-50/20 to-violet-100/40 text-slate-800 overflow-hidden relative backdrop-blur-sm">
      <style jsx>{`
        .mouse-gradient {
          position: fixed;
          pointer-events: none;
        ...
        <div className="text-center max-w-5xl mx-auto relative">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-900 relative">
            <div className="mb-4 md:mb-6">
              <span className="word-animate" data-delay="700">About</span>
              <span className="word-animate" data-delay="850">Me</span>
            </div>
            <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-600 leading-relaxed tracking-wide">
              <span className="word-animate" data-delay="1400">Sophomore at MIT WPU (CSE)</span><br/>
              <span className="word-animate" data-delay="1550">Knows Java, C, MERN, Next.js, </span>
              <span className="word-animate" data-delay="1700">Blockchain, </span>
              <span className="word-animate" data-delay="1850">HTML, Git, Tailwind CSS, Bootstrap, Material UI, </span>
              <span className="word-animate" data-delay="2000">Proficient in English, Hindi, Marathi, German</span>
...
export default DigitalSerenity2;