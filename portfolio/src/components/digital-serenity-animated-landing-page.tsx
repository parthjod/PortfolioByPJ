        ...
        <div className="text-center max-w-5xl mx-auto relative">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-900 relative">
            <div className="mb-4 md:mb-6">
              <span className="word-animate" data-delay="700">Parth A</span>
              <span className="word-animate" data-delay="850">Jain</span>
            </div>
            <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-600 leading-relaxed tracking-wide">
              <span className="word-animate" data-delay="1400">Full Stack Developer, </span>
              <span className="word-animate" data-delay="1550">Blockchain Developer,</span>
              {/* <span className="word-animate" data-delay="1700">Java, </span>
              <span className="word-animate" data-delay="1850">C, </span> */}
              <span className="word-animate" data-delay="2000">And Dictator.</span>
            </div>
